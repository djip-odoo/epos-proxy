...
func (bm *BluetoothManager) setBinding(mac string, b *rfcommBinding) {
	oldBinding, ok := bm.cache.get(mac)
...
func (c *serialConn) LocalAddr() net.Addr  { return netAddrPlaceholder{net: "rfcomm-serial", addr: c.path} }
func (c *serialConn) RemoteAddr() net.Addr { return netAddrPlaceholder{net: "rfcomm-serial", addr: c.path} }
