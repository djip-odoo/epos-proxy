        ...
        <div class="relative bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div class="p-6 space-y-5">
            ...
            <div v-else class="space-y-4 text-gray-600 leading-relaxed text-sm">
              ...
              <p class="text-xs text-gray-500">This is a one-time setup.</p>
              <p class="text-xs" v-if="os != 'darwin'">
                If you choose "Not Now", the application will continue to work, but network printing from other devices will not be available until firewall access is enabled.
              </p>
              <p class="text-xs" v-else>
                macOS uses an application-level firewall, which cannot be configured automatically by this application. If the macOS firewall is enabled, allow this application in <strong>System Settings → Privacy & Security → Firewall</strong> to enable network printing from other devices.
              </p>
            </div>
