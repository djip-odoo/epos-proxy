...
function zadigSteps(printerName) {
    return [
        {
        ...
        },
        {
            ...
            desc: `Find the *printer* in the dropdown list. The name may vary, but it should look similar to *${printerName}*.`,
            image: image2,
        },
        {
...
function brewSteps(printerName) {
    return [
        {
        ...
        },
        {
            ...
            desc: `Unplug and replug your printer *${printerName}*. The driver should now be detected automatically.`,
        },
    ]
}

function linuxSteps(printerName) {
    return [
        {
            title: 'Install libusb',
...
export default function getFixSteps(os, { printerName }) {
    if (os === "windows") {
