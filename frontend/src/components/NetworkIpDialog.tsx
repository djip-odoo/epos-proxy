...
export default function NetworkIpDialog() {
  ...
  return (
    <Dialog
      ...
      onClose={cleanup}
      openButton={
        <div className="flex-1 w-full border-2 border-dashed border-gray-300 bg-gray-50 rounded-lg text-center text-gray-600 hover:border-gray-400 hover:bg-gray-100 cursor-pointer flex items-center justify-center gap-2 transition-colors">
